...
| BF-009 | In progress | The client now durably merges household event streams and sends independent server-sequence cursors, avoiding repeated downloads of completion, reset, victory, and wallet history. Reward status sequencing, bounded pagination, revision-gated mutable configuration, and hash-gated avatar transfer remain. |

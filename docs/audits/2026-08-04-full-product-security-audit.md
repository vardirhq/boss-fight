...
| BF-020 | In progress | Shared request validators now reject string/number coercion for booleans and cap configuration and mutation arrays at 200 objects before database work. Route-level schemas, consistent string/numeric bounds, and avatar MIME/size validation remain. |

...
| BF-019 | In progress | Schemas, governance, synchronization helpers/projections, privacy, retention, session policy, observability, the public error policy, operational routes, authorized gameplay routes, and invitation/pairing token lifecycle routes are isolated and independently tested. Authentication/account, household/account-governance, and sync route registration still need extraction from the composition root. |

...
| BF-005 | In progress | A bilingual privacy notice, versioned child-authorization records, owner/parent household export, and transactional child-identity erasure are implemented. Counsel review, adult/household erasure, enforced retention, processor details, real-database coverage, and backup-erasure testing remain. |

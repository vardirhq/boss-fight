...
| BF-005 | In progress | A bilingual privacy notice, versioned child-authorization records, and owner/parent household export are implemented. Counsel review, self-service erasure, enforced retention, processor details, and backup-erasure testing remain. |

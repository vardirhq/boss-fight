...
| BF-019 | In progress | Schemas, governance, synchronization helpers/projections, privacy, retention, session policy, observability, the public error policy, operational, gameplay, invitation/pairing, sync, and authentication/account boundaries are isolated and independently tested. Household bootstrap, configuration, privacy, and account-governance route registration still need extraction from the composition root. |

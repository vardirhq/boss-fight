...
| BF-005 | In progress | A bilingual privacy notice, versioned child authorization, household export, transactional child and household erasure, and transient-record/deleted-avatar retention are implemented. Counsel review, adult-account erasure, active-data and backup lifecycle rules, processor details, and real-database/backup-erasure testing remain. |

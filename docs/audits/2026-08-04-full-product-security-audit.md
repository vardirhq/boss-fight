...
| BF-005 | In progress | A bilingual privacy notice, versioned child authorization, household export, transactional child/household/adult-account erasure, and transient-record/deleted-avatar retention are implemented. Counsel review, active-data and backup lifecycle rules, processor details, and real-database/backup-erasure testing remain. |

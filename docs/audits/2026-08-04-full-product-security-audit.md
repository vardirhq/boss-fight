...
| BF-020 | In progress | Shared request validators reject string/number coercion for booleans and cap configuration and mutation arrays at 200 objects before database work. Avatar uploads require supported MIME signatures, canonical base64, matching SHA-256, and at most 512 KiB decoded. Route-level schemas and consistent string/numeric bounds remain. |
